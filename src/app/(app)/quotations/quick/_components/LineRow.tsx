...
// One quick-quote line. Catalog picker button becomes a
// "change product" link once picked; primary inputs sit in a
// dense grid; per-line total renders on the right.
...
export function LineRow({ line, onChange, onOpenPicker, onRemove }: LineRowProps) {
  return (
    <div className="grid grid-cols-[3px_1fr] gap-2 rounded-[10px] border border-rule bg-surface overflow-hidden">
      <div className="self-stretch" style={{ background: line.hex ?? "var(--color-rule)" }} aria-hidden />
      <div className="p-3">
