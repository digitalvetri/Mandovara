...
// Sheets to skip: duplicate coverage, stock lists, or ambiguous
// families we can classify later once the owner clarifies.
const SKIP_SHEETS = new Set([
  "CURTAIN MAIN & SHEER",  // duplicated across CURTAIN MAIN + CURTAIN SHEER
  "PAMPLETS",              // family unclear
